...
parser.add_argument("--save_path", type=str, default="save/wo_cog_")
parser.add_argument("--model_path", type=str, default="save/wo_cog_")
parser.add_argument("--save_path_dataset", type=str, default="save/wo_cog_")
...
parser.add_argument("--woCOG", default=True, action="store_true")
