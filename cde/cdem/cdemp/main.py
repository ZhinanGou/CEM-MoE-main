...
from src.models.MRMD.model import MRMD
#from src.models.CEM.model import CEM
from src.models.CEM.model1 import CEM

from src.models.CDEMP.model import CDEMP
from src.models.CEMP.model import CEMP
...
def train(model, train_set, dev_set):
    ...
    try:
        ...
        for n_iter in tqdm(range(1000000)):
            if "cem" in config.model or "cdemp" in config.model or "cemp" in config.model: 
